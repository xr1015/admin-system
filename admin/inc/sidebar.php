  ...
  <div class="aside">
    ...
    <ul class="nav">
      ...
      <li <?php echo in_array($current_page, $menu_posts) ? 'class="active"':'' ?>>
        <a href="/admin/#menu-posts" class="collapsed" <?php echo in_array($current_page, $menu_posts) ? '':'class="active"' ?>data-toggle="collapse">
      ...
      <li <?php echo in_array($current_page, $menu_settings) ? 'class="active"':'' ?>>
        <a href="/admin/#menu-settings" class="collapsed" data-toggle="collapse" <?php echo in_array($current_page, $menu_settings) ? '':'class="active"' ?>>
